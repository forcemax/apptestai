...
![Machine Setting](/img/virtualbox-machine-setting.png|width=360px)
![Machine Setting - USB](/img/virtualbox-usb-setting.png|width=360px)
![Machine Setting - USB - Device Select](/img/virtualbox-usb-setting-device-select.png|width=360px)
![Machine Setting - USB - OK](/img/virtualbox-usb-setting-final.png|width=360px)
